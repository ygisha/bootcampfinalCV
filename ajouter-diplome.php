	           		...
	           		<div class="well">
						<form action="" method="POST" role="form" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input name="datefin" type="text" class="form-control" id="" placeholder="jj/mm/aaaa" value="<?php if (isset($_GET['id'])) echo $dataU['datefin']; ?>">
							</div>
					...
					<tbody>
						<?php 
							...
							$list=" SELECT 
									...
									FROM diplomes
									INNER JOIN codeuses
								  ON diplomes.id = diplomes.id_codeuses";
